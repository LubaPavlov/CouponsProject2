...
public class ConnectionPoolSingleton {
	 ...
	 * @return Connection A connection with the SQL Database
	 ...
	 * @param connection The given connection with the SQL Database that we want to return
	 * @throws MyException SQL exception
	 */
	...
	private Connection createConnection() throws MyException {
		try	{
			...
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/dafna_schema","root", "root");
			return connection;
		}
		catch (Exception e){
